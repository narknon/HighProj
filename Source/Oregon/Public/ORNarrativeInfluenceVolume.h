...
#include "ORNarrativeInfluenceVolume.generated.h"

class AActor;
class APostProcessVolume;

UCLASS(Blueprintable)
class OREGON_API AORNarrativeInfluenceVolume : public AORInnerOuterVolumeInterpolator {
    GENERATED_BODY()
public:
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bIsHidingHUDPrompts;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSoftObjectPtr<APostProcessVolume> RackFocusPostProcessVolume;
    
public:
    AORNarrativeInfluenceVolume();
    UFUNCTION(BlueprintCallable)
    void SetRackFocusEnabled(bool bEnabled);
    
    UFUNCTION(BlueprintCallable)
    void SetNarrativeFollowEnabled(bool bEnabled);
    
    UFUNCTION(BlueprintCallable)
    void SetNarrativeAimEnabled(bool bEnabled);
