...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static int32 PostEventToComponent(UAkAudioEvent* AkEvent, UAkComponent* AkComponent, int32 CallbackMask, const FOnAkPostEventCallback& PostEventCallback, const TArray<FAkExternalSourceInfo>& ExternalSources, bool bStopWhenAttachedToDestroyed, const FString& EventName);
    ...
    UFUNCTION(BlueprintCallable)
    static UAkComponent* GetAkComponentByTag(USceneComponent* AttachToComponent, FName ComponentTag);
