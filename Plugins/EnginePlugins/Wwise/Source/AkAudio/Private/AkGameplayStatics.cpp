...
int32 UAkGameplayStatics::PostEventToComponent(UAkAudioEvent* AkEvent, UAkComponent* AkComponent, int32 CallbackMask, const FOnAkPostEventCallback& PostEventCallback, const TArray<FAkExternalSourceInfo>& ExternalSources, bool bStopWhenAttachedToDestroyed, const FString& EventName) {
    return 0;
}
...
UAkComponent* UAkGameplayStatics::GetAkComponentByTag(USceneComponent* AttachToComponent, FName ComponentTag) {
    return NULL;
}
